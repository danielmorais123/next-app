...
import { signInWithFacebook, signInWithGoogle } from "../../lib/authfunctions";
        ...
        <div className="max-w-[400px] w-full rounded-xl flex items-center p-2 flex-col ">
          ...
          <div className="flex flex-col lg:items-center items-start w-full space-y-2 mt-2">
            <p className="text-xs">
              ...
              <a href="/auth/register" className="ml-2 text-blue-500 underline">
                Register
              </a>
            </p>
            <p className="text-xs">
          ...
          <div className="w-full lg:w-fit flex justify-start lg:justify-center">
            <p className="text-sm">Or Sign in using another provider</p>
          </div>
